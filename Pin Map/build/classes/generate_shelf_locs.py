...
def update_world_db():
    db = pd.read_excel("C:/Users/clare/Documents/Field_Session/Python Addition/countries.xls")
    return db

# this function inits the us database from excel sheet 
# the file path is absolute - you must change it to each specific machine
def update_us_db():
    db = pd.read_excel("C:/Users/clare/Documents/Field_Session/Python Addition/US-counties.xlsx")
    return db
...
# the file path is absolute - you must change it to each specific machine
f = open("C:/Users/clare/Documents/Field_Session/Python Addition/Visitors.csv",'a')
writer = csv.writer(f)
